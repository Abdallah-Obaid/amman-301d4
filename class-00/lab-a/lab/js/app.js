...
function displayPics(){
  ...
  // Main difference is scoping rules. Variables declared by var keyword are scoped to the immediate function body (hence the function scope) while const variables are scoped to the immediate enclosing block denoted by { } (hence the block scope).
  console.log(viewed);
